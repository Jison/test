...
// warnings (non-severe errors). If the strict mode is on, will throw these exceptions;
...
/**
  * ParserInternalException indicates a Parser bug
  */
class ParserInternalException(msg: String) extends Exception
